...
def main():
    ...
    x = [
        [3, 7, 12, 14, 19, 3, 3, 1, 2.5, 2.5],
        [2, 5, 9, 13, 22, 3, 3, 3, 2.5, 2.5],
        [3, 6, 10, 14, 21, 3, 3, 3, 2.5, 0.5],
        [4, 7, 12, 18, 21, 3, 2.5, 3, 2.5, 2.5],
        [5, 8, 12, 16, 19, 3, 3, 3, 2.5, 2.5],
        [6, 9, 11, 14, 21, 3, 1, 3, 2.5, 2.5],
        [7, 10, 12, 15, 19, 3, 1, 3, 0.5, 0.5],
        [8, 11, 13, 18, 22, 1, 3, 3, 2.5, 2.5],
        [9, 12, 12, 17, 20, 1, 3, 3, 2.5, 1.5],
        [10, 13, 16, 19, 22, 1, 1, 1, 2.5, 2.5],
        [11, 14, 12, 15, 19, 1, 3, 3, 2.5, 2.5],
        [12, 15, 12, 16, 19, 1, 3, 3, 2.5, 2.5],
        [6, 11, 14, 18, 21, 3, 3, 3, 2.5, 2.5],
        [7, 12, 12, 16, 19, 3, 3, 3, 2.5, 2.5],
        [8, 13, 12, 15, 19, 3, 3, 3, 1.5, 1.5],
        [9, 14, 12, 15, 19, 3, 3, 3, 2.5, 2.5],
        [10, 15, 12, 15, 19, 1, 1, 3, 0.5, 2.5],
        [11, 16, 12, 15, 19, 1, 3, 3, 2.5, 0.5]
    ]
