...
\begin{itemize}
    \item \textbf{Apenas referência}:~\cite{rfc1}
    \item \textbf{Apenas data}:~\citedate{rfc1}
    \item \textbf{Apenas ano}:~\citeyear{rfc1}
    \item \textbf{Apenas autor}:~\citeauthor{rfc1}
    \item \textbf{Apenas editor}:\citelist{rfc1}{organization}
    \item \textbf{Autor e referência}:\citet{rfc1}
\end{itemize}
