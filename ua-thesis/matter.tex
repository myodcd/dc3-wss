...
\renewcommand{\chaptermark}[1]{\markboth{\thechapter.#1}{}} % Capítulos em minúsculas
  ...
  \fancyhead[L]{\leftmark}                                  % Single-sided: header left
  \fancyhead[R]{\thepage}                                   % Single-sided: header right
  \fancyfoot[L]{\authornam}                                % Single-sided: footer left
  \fancyfoot[R]{\textit{\thesisdegree\ Degree}}            % Single-sided: footer right
...
%\include{chapters/chapter1} % INCLUIR NOVAMENTE
